...
public class XMLUtilsTest {
    ...
    private static String SYMBOL = "VNET";
    private static String PRICE = "110.10";
    private static String TIME = "2015-02-10 00:00:01";
    ...
    public void testUnmarshall() throws Exception {
        ...
        validateFamily(stocks.getStock().get(0));
    }
    ...
    private void validateFamily(Stock stock) {
        assertTrue("Symbol name is correct", stock.getSymbol().equals(SYMBOL));
        assertTrue("Price is correct", stock.getPrice().equals(PRICE));
        assertTrue("Time is correct", stock.getTime().equals(TIME));
    }
