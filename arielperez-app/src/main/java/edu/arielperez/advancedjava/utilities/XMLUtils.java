...
public class XMLUtils {
    ...
    /**
     * Put the provided XML file into the specified XML Domain Object using JAXB without using
     * schema validation.
     *
     * @param xmlInstance an XML instance that matched the XML Domain object specified by T
     * @param T           a XML Domain object class which corresponds the XML instance
     ...
     * @throws InvalidXMLException if the provided  xmlInstance cannot be successfully parsed.
     */
    public static <T extends XMLDomainObject> T unmarshall(File xmlInstance, Class T)
            throws InvalidXMLException {
        T returnValue;
        try {
            Unmarshaller unmarshaller = createUnmarshaller(T);
            returnValue = (T) unmarshaller.unmarshal(xmlInstance);
        } catch (JAXBException e) {
            throw new InvalidXMLException("JAXBException issue: " + e.getMessage(), e);
        }
        return returnValue;
    ...
    /**
     * Put the provided XML file into the specified XML Domain Object using JAXB using
     * schema validation.
     *
     * @param xmlInstance an XML instance that matched the XML Domain object specified by T
     * @param T           a XML Domain object class which corresponds the XML instance
     ...
     * @throws InvalidXMLException if the provided  xmlInstance cannot be successfully parsed.
     */
    public static <T extends XMLDomainObject> T unmarshall(File xmlInstance, Class T, String schemaName)
            throws InvalidXMLException {
